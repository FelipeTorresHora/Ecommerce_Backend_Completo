...
import felipe.proj.ecombackend.seguranca.jwt.AuthTokenFiltro;
import felipe.proj.ecombackend.seguranca.jwt.JwtAuthEntryPoint;
...
public class EcomConfig {
    ...
    @Bean
    public AuthTokenFiltro authTokenFilter() {
